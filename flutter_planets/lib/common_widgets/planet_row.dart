...
class PlanetRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //  all our text styles use the same font, we can create a base style indicating the font
    final baseTextStyle =  new TextStyle(
      fontFamily: 'Poppins'
    );
    
    final TextStyle regularTextStyle = baseTextStyle.copyWith(
    ...
    //  header style
    final TextStyle headerTextStyle = baseTextStyle.copyWith(
      color: Colors.white,
      fontSize: 18.0,
